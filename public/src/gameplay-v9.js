...
function installFreeRoamEntry() {
  ...
  section.innerHTML = `
    ...
    <p>Свободный онлайн-сценарий для одного или двух игроков: доставка припасов, поиск автомата, погоня с тремя катерами, буксир, таран, выход на берег, плавание и угон свободной лодки.</p>
