...
export const CORE_VESSEL_MODULE_TYPES = Object.freeze([
  Object.freeze({
    ...
    persistentStateFields: ["enabled", "health"],
  ...
  Object.freeze({
    ...
    persistentStateFields: ["enabled", "health", "amount"],
  ...
  Object.freeze({
    ...
    persistentStateFields: ["enabled", "health", "items"],
    createState: () => ({enabled: true, health: 100}),
  }),
  Object.freeze({
    id: "sonar",
  ...
  Object.freeze({
    ...
    persistentStateFields: ["enabled", "health", "ammo"],
