...
import {VESSEL_IMPACT_ROUTING_SYSTEMS} from "./systems/vessel-impact-routing-system.js?v=2";
import {VESSEL_ZONE_WATER_SYSTEMS} from "./systems/vessel-zone-water-system.js?v=2";
import {VESSEL_WATER_MOBILITY_SYSTEMS} from "./systems/vessel-water-mobility-system.js?v=2";
import {VESSEL_WATER_AUTHORITY_PERSISTENCE_SYSTEMS} from "./systems/vessel-water-authority-persistence-system.js?v=1";
import {VESSEL_MODULE_REPAIR_SYSTEMS} from "./systems/vessel-module-repair-system.js?v=5";
import {VESSEL_MERCHANT_RECOVERY_SYSTEMS} from "./systems/vessel-merchant-recovery-system.js?v=3";
import {VESSEL_OWNERSHIP_SYSTEMS} from "./systems/vessel-ownership-system.js?v=2";
import {VESSEL_DECK_BOARDING_SYSTEMS} from "./systems/vessel-deck-boarding-system.js?v=1";
import {VESSEL_DECK_INPUT_BRIDGE_SYSTEMS} from "./systems/vessel-deck-input-bridge-system.js?v=5";
...
import {VESSEL_PROPULSION_AUTHORITY_SYSTEMS} from "./systems/vessel-propulsion-authority-system.js?v=1";
...
export function installVesselPlugins(registry) {
  ...
  for (const system of VESSEL_WATER_MOBILITY_SYSTEMS) registry.registerSystem(system);
  ...
  for (const system of VESSEL_IMPACT_ROUTING_SYSTEMS) registry.registerSystem(system);
  for (const system of VESSEL_WATER_AUTHORITY_PERSISTENCE_SYSTEMS) registry.registerSystem(system);
  for (const system of VESSEL_PROPULSION_AUTHORITY_SYSTEMS) registry.registerSystem(system);
