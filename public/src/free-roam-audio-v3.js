...
import {FreeRoamAudio as BaseFreeRoamAudio} from "./free-roam-audio-v2.js?v=41";
import {relativeMovementPan} from "./free-roam-audio-spatial.js?v=1";

export {relativeMovementPan} from "./free-roam-audio-spatial.js?v=1";
