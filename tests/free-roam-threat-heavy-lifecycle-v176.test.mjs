...
test("the shared heavy lifecycle reset removes only the old heavy and its owned processes", () => {
...
test("the source-level reset is ordered before the encounter number advances", () => {
