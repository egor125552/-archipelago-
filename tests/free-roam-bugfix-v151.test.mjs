...
test("audio wrappers target the same audio class as the live client", async () => {
  ...
  assert.match(pistolSource, /free-roam-audio-v5\.js\?v=45/);
  assert.match(qualitySource, /free-roam-audio-v5\.js\?v=45/);
  assert.match(clientSource, /free-roam-audio-v5\.js\?v=45/);
